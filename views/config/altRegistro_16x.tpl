...
<form id="configuration_form" class="defaultForm  form-horizontal" action="{$tab_1['formAction']}&origem=altRegistro" method="post" enctype="multipart/form-data">
    ...
    <div class="fkcustomers-panel" style="border-top-left-radius: 0">
        ...
        <div class="fkcustomers-panel">
            ...
            <div class="fkcustomers-panel-heading">
                {l s="Alteração da Licença" mod="fkcustomers"}
            </div>
            ...
            <div class="fkcustomers-form">
                ...
                <div class="fkcustomers-col-lg-25 fkcustomers-float-left">
                    <input disabled="disabled" type="text" name="fkcustomers_referencia" id="fkcustomers_referencia" value="{$tab_1['fkcustomers_referencia']}">
                </div>
            </div>
            ...
            <div class="fkcustomers-form">
                ...
                <div class="fkcustomers-col-lg-25 fkcustomers-float-left">
                    <input disabled="disabled" type="text" name="fkcustomers_proprietario" id="fkcustomers_proprietario" value="{$tab_1['fkcustomers_proprietario']}">
                </div>
            </div>
            ...
            <div class="fkcustomers-panel-footer">
                <button type="submit" value="1" name="btnSubmit" class="fkcustomers-button fkcustomers-float-right">
                    ...
                    {l s="Alterar registro" mod="fkcustomers"}
                </button>
            </div>
        </div>
    </div>
