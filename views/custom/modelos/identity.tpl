            ...
            <fieldset>
                ...
                <div class="clearfix">
                    ...
                    <div class="radio-inline">
                        <label for="tipo">
                            <input type="radio" name="tipo" id="tipo" value="pf" onclick="procRadioTipo(this);" {if !isset($smarty.post.tipo) or isset($smarty.post.tipo) and $smarty.post.tipo == 'pf'} checked="checked"{/if}/>
                    ...
                    <div class="radio-inline">
                        <label for="tipo">
                            <input type="radio" name="tipo" id="tipo" value="pj" onclick="procRadioTipo(this);" {if isset($smarty.post.tipo) and $smarty.post.tipo == 'pj'} checked="checked"{/if}/>
                            {l s='Jurídica' mod='fkcustomers'}
                        </label>
                    </div>

                    <div id="fkcustomers_pf" {if !isset($smarty.post.tipo) or isset($smarty.post.tipo) and $smarty.post.tipo == 'pf'} style="display:block" {else} style="display:none"{/if}>
                        <div class="required form-group">
                            <label for="fkcustomers_cpf">{l s='CPF' mod='fkcustomers'} <sup>*</sup></label>
                            <input type="text" class="is_required form-control" name="fkcustomers_cpf" id="fkcustomers_cpf" value="{if isset($smarty.post.cpf_cnpj)}{$smarty.post.cpf_cnpj}{/if}"/>
                        </div>
                        <div class="required form-group">
                            <label for="fkcustomers_rg">{l s='RG' mod='fkcustomers'}</label>
                            <input type="text" class="is_required form-control" name="fkcustomers_rg" id="fkcustomers_rg" value="{if isset($smarty.post.rg_ie)}{$smarty.post.rg_ie}{/if}"/>
                        </div>
                    </div>

                    <div id="fkcustomers_pj" {if isset($smarty.post.tipo) and $smarty.post.tipo == 'pj'} style="display:block" {else} style="display:none"{/if}>
                        <div class="required form-group">
                            <label for="fkcustomers_cnpj">{l s='CNPJ' mod='fkcustomers'} <sup>*</sup></label>
                            <input type="text" class="is_required form-control" name="fkcustomers_cnpj" id="fkcustomers_cnpj" value="{if isset($smarty.post.cpf_cnpj)}{$smarty.post.cpf_cnpj}{/if}"/>
                        </div>
                        <div class="required form-group">
                            <label for="fkcustomers_ie">{l s='IE' mod='fkcustomers'}</label>
                            <input type="text" class="is_required form-control" name="fkcustomers_ie" id="fkcustomers_ie" value="{if isset($smarty.post.rg_ie)}{$smarty.post.rg_ie}{/if}"/>
                        </div>
                    </div>
                ...
                <h1 class="page-subheading">{l s='Suas Informações Pessoais' mod='fkcustomers'}</h1>
