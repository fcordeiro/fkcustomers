            ...
            <fieldset>
                ...
                <div class="clearfix">
                    ...
                    *}
                    ...
                    <div class="radio-inline">
                        <label for="tipo_2">
                            <input type="radio" name="tipo" id="tipo_2" value="pj" disabled/>
                            {l s='Jurídica' mod='fkcustomers'}
                        </label>
                    </div>
                    ...
                    <div id="fkcustomers_pf" {if !isset($smarty.post.tipo) or isset($smarty.post.tipo) and $smarty.post.tipo == 'pf'} style="display:block" {else} style="display:none"{/if}>
                        <div class="required form-group">
                            ...
                            <input type="tel" onkeyup="maskIt(this, event, '###.###.###-##');" maxlength="14" class="is_required form-control" name="fkcustomers_cpf" id="fkcustomers_cpf" value="{if isset($smarty.post.cpf_cnpj)}{$smarty.post.cpf_cnpj}{/if}"/>
                        </div>
                        <div class="required form-group">
                            <label for="fkcustomers_rg">{l s='RG' mod='fkcustomers'}</label>
                            <input type="text" placeholder="{l s='Opcional' mod='fkcustomers'}" class="is_required form-control" name="fkcustomers_rg" id="fkcustomers_rg" value="{if isset($smarty.post.rg_ie)}{$smarty.post.rg_ie}{/if}"/>
                        </div>
                    </div>
