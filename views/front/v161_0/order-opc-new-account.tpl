		...
		<fieldset>
			<div class="box">
				...
				<div id="opc_account_form" class="unvisible">
                    ...
                    <div class="text form-group" id="fkcustomers_company" {if $TipoPessoa == 'pf'} style="display: none" {else} style="display: block"{/if}>
                    ...
                    <input type="hidden" class="text form-control validate" name="postcode" id="postcode" data-validate="isPostCode" value="{if isset($guestInformations) && isset($guestInformations.postcode) && $guestInformations.postcode}{$guestInformations.postcode}{/if}" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
                ...
                {*** FKcustomers - numend e compl - fim ***}
					...
					<div class="form-group is_customer_param">
						...
						<input type="tel" onkeyup="maskIt(this,event,'(##) ####-#####');" maxlength="15" placeholder="(00)0000-00000" class="text form-control validate" name="phone" id="phone"  data-validate="isPhoneNumber" value="{if isset($guestInformations) && isset($guestInformations.phone) && $guestInformations.phone}{$guestInformations.phone}{/if}" />
					</div>
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
						<label for="phone_mobile">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
                                                <input type="tel" onkeyup="maskIt(this,event,'(##) ####-#####');" maxlength="15" placeholder="(00)0000-00000" class="text form-control validate" name="phone_mobile" id="phone_mobile" data-validate="isPhoneNumber" value="{if isset($guestInformations) && isset($guestInformations.phone_mobile) && $guestInformations.phone_mobile}{$guestInformations.phone_mobile}{/if}" />
					</div>
