			...
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<div class="required form-group">
						...
						<input type="text" placeholder="Somente primeiro nome, ex: Maria" class="is_required validate form-control" data-validate="isName" id="firstname" name="firstname" value="{if isset($smarty.post.firstname)}{$smarty.post.firstname}{/if}" />
					</div>
					<div class="required form-group">
						<label for="lastname">{l s='Last name'} <sup>*</sup></label>
						<input type="text" placeholder="Somente sobrenome, ex: da Silva Santos" class="is_required validate form-control" data-validate="isName" id="lastname" name="lastname" value="{if isset($smarty.post.lastname)}{$smarty.post.lastname}{/if}" />
					</div>
					...
					{foreach from=$dlv_all_fields item=field_name}
						{if $field_name eq "company"}
                            {*** FKcustomers - company - inicio ***}
							<div style="display: none;" class="form-group" id="fkcustomers_company" {if isset($smarty.post.tipo) and $smarty.post.tipo == 'pj'} style="display: block" {else} style="display: none"{/if}>
								<label for="company">{l s='Company'}{if in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
								<input type="text" class="form-control" id="company" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}" />
							</div>
                            {*** FKcustomers - company - fim ***}
						...
						{elseif $field_name eq "postcode"}
							...
							<div class="required postcode form-group">
                                ...
                                {*** FKcustomers - postcode - inicio ***}
                                <input type="hidden" class="form-control" name="postcode" id="postcode" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{/if}" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
                                <input type="tel" onkeyup="maskIt(this,event,'#####-###');" maxlength="9" class="form-control" name="postcode_fk" id="postcode_fk" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{else}{if isset($address->postcode)}{$address->postcode}{/if}{/if}"/>
                                {*** FKcustomers - postcode - fim ***}
							</div>
                        ...
                        {*** FKcustomers - numend e compl - inicio ***}
						...
						{/if}
                        {*** FKcustomers - numend e compl - fim ***}
					{/foreach}
					...
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
						...
						<input type="tel" onkeyup="maskIt(this,event,'(##) ####-#####');" maxlength="15" placeholder="(00)0000-00000" class="form-control" name="phone_mobile" id="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}" />
					</div>
		...
		{if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
			<div class="account_creation">
				...
				{foreach from=$dlv_all_fields item=field_name}
					...
					{elseif $field_name eq "postcode"}
						...
						<p class="required postcode form-group">
                            ...
                            {*** FKcustomers - postcode - inicio ***}
							<input type="hidden" class="form-control" name="postcode" id="postcode" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{/if}" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
                            <input type="text" class="form-control" name="postcode_fk" id="postcode_fk" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{else}{if isset($address->postcode)}{$address->postcode}{/if}{/if}"/>
                            {*** FKcustomers - postcode - fim ***}
						</p>
					{elseif $field_name eq "city"}
						<p class="required form-group">
				...
				<p class="form-group">
					...
					<input type="tel" onkeyup="maskIt(this,event,'(##) ####-#####');" maxlength="15" placeholder="(00)0000-00000" class="form-control" name="phone" id="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{/if}" />
				</p>
