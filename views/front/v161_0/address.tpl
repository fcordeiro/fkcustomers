		...
		{foreach from=$ordered_adr_fields item=field_name}
			...
			{if $field_name eq 'postcode'}
				...
				<div class="required postcode form-group unvisible">
					...
					<input class="is_required validate form-control" data-validate="{$address_validation.$field_name.validate}" type="hidden" id="postcode" name="postcode" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{else}{if isset($address->postcode)}{$address->postcode|escape:'html':'UTF-8'}{/if}{/if}" />
			...
			{if $field_name eq 'phone'}
				...
				<div class="form-group phone-number">
					...
					<input onkeyup="maskIt(this,event,'(##) ####-#####');" maxlength="15" class="{if isset($one_phone_at_least) && $one_phone_at_least}is_required{/if} validate form-control" data-validate="{$address_validation.phone.validate}" type="tel" id="phone" name="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{else}{if isset($address->phone)}{$address->phone|escape:'html':'UTF-8'}{/if}{/if}"  />
				</div>
